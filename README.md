...
![Overview of the Lipschitz budget framework](iclr2026_opening_figure.png)
...
We provide exemplary data for the shape and CelebA experiments in 'data'.

#### 3D Shapes

We provide the Stanford Bunny. Additional shapes can be downloaded from [here](https://github.com/alecjacobson/common-3d-test-models). Note that not all meshes are watertight; we only used: `armadillo`, `beast`, `bimba`, `cow`, `homer`, `ogre`, `spot`, `stanford-bunny`, `suzanne`, `teapot`.

Data location: `./data/common-3d-test-models/`
